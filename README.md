...
|---|---|---|---|---|
| Edu EPUB Creator | [`creator/`](creator/) | 0.5.1 | MIT | Browser-based authoring tool: visual/XHTML/preview editing, ~40 reusable learning blocks, Word/Markdown/EPUB/HTML import, EPUB 3 export with accessibility metadata and an advisory pre-export check |
