(function () {
  ...
  const LANGUAGE_KEY = "edu-epub-creator:language";
  const TRANSLATIONS = {
    en: {
      languageLabel: "Language",
      installTitle: "Install the application on your device",
      installSubtitle: "Author accessible, interactive educational EPUB 3 books locally, with an offline app shell and support for desktop, tablet and mobile use.",
      ...
      androidStep3: "Open Edu EPUB Creator from the new icon on the home screen.",
      ...
      installedStatus: "You can open Edu EPUB Creator from the device icon.",
    ...
    el: {
      ...
      installSubtitle: "Δημιουργεί προσβάσιμα, διαδραστικά εκπαιδευτικά EPUB 3 τοπικά, με offline app shell και υποστήριξη για υπολογιστή, tablet και κινητό.",
      ...
      androidStep3: "Άνοιξε το Edu EPUB Creator από το νέο εικονίδιο στην αρχική οθόνη.",
      ...
      installedStatus: "Μπορείς να ανοίγεις το Edu EPUB Creator από το εικονίδιο της συσκευής.",
  ...
  installButton.addEventListener("click", async () => {
    ...
    if (isIos) { setStatus(t("iosClickStatus")); return; }
    if (location.protocol === "file:") { setStatus(t("fileClickStatus")); return; }
  ...
  function loadLanguage() {
    try { const saved = localStorage.getItem(LANGUAGE_KEY); return saved === "el" ? "el" : "en"; }
    catch (_) { return "en"; }
  }
