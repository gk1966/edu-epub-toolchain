...
const checks = {
  ...
  ncxWired: app.includes("function tocNcx") && app.includes('<spine toc="ncx">') && app.includes("interactiveFallbackXhtml") && app.includes('fallback="${xmlAttr(item.fallbackId)}"'),
  a11yMeta: app.includes("function accessibilityMeta") && app.includes("schema:accessMode") && app.includes("schema:accessibilityHazard\">unknown") && !app.includes("schema:accessModeSufficient"),
